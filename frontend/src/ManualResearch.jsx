...
const PROMPT_URL = 'http://localhost:3001/api/prompts/agent1';
const SAVE_URL = 'http://localhost:3001/api/runs/manual';
      ...
      {savedRun && (
        <div className="result-container">
          ...
          <div className="run-meta">
            <MetaItem label="Industry" value={savedRun.industry} />
            <MetaItem label="Status" value={savedRun.status} highlight={savedRun.status} />
            <MetaItem label="Mode" value={savedRun.mode} />
            <MetaItem label="Model" value={savedRun.model} />
            <MetaItem label="Run ID" value={savedRun.id} mono />
            <MetaItem label="Created" value={new Date(savedRun.createdAt).toLocaleString()} />
          </div>
